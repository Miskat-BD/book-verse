    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (data) {
                ...
                router.refresh(); // নেভবারে সেশন আপডেট করার জন্য
            }
            if (error) {
    ...
    return (
        <div className="max-w-7xl mx-auto my-16 px-4">
            ...
            <div className="my-6 text-center">
                ...
                <p className="text-slate-500 mt-2">Log in to your BookVerse account</p>
            </div>
            ...
            <Card className="max-w-md mx-auto p-6 sm:p-8 border border-slate-100 bg-white shadow-md flex justify-center items-center">
                ...
                <div className="w-full mt-6">
                    ...
                    <button 
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl transition-all text-sm font-semibold shadow-sm cursor-pointer"
                    >
